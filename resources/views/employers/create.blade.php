                ...
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="row" action="{{route('employer.create.post')}}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="col-sm-12">
                                    <input type="hidden" name="access_regions" id="selectedRegions" value="{{old('access_regions')}}">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="col-sm-4 regions">
                                ...
                                <div class="list">
                                    <ul>
                                        <?php $access_regions = explode(',', old('access_regions'));?>
