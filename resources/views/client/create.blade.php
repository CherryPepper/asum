...
@section('content')
    <div class="content create-client">
        <div class="container-fluid">
            <div class="row">
                <div class="panel">
                    <div class="panel-heading">
                        Укажите данные абонента
                    </div>
                    <div class="panel-body">
                        <form class="row" action="{{route('client.create.post')}}" method="post">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-wrapper col-sm-4">
                                        ...
                                        <div class="form-group {{$errors->has('last_name') ? 'has-error' : ''}}">
                                            <input type="text" class="form-control input-lg" name="last_name" value="{{old('last_name')}}">
                                        </div>
                                    </div>
                                    <div class="form-wrapper col-sm-4">
                                        @if(!$errors->has('email'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-wrapper col-sm-4">
                                        ...
                                        <div class="form-group {{$errors->has('passport') ? 'has-error' : ''}}">
                                            <input type="text" class="form-control input-lg" name="passport" value="{{old('passport')}}">
                                        </div>
                                    </div>
                                    <div class="form-wrapper col-sm-4">
                                        ...
                                        <div class="form-group {{$errors->has('passport_mvd') ? 'has-error' : ''}}">
                                            <input type="text" class="form-control input-lg" name="passport_mvd" value="{{old('passport_mvd')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-wrapper col-sm-4">
                                        ...
                                        <div class="form-group {{$errors->has('contract') ? 'has-error' : ''}}">
                                            <input type="text" class="form-control input-lg" name="contract" value="{{old('contract')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-wrapper col-sm-4">
                                        ...
                                        <div class="form-group {{$errors->has('login') ? 'has-error' : ''}}">
                                            <input type="text" class="form-control input-lg" name="login" value="{{old('login')}}">
                                        </div>
                                    </div>
                                    <div class="form-wrapper col-sm-4">
                                    ...
                                    <label class="mb-15">
                                        <span class="name">
                                            <input type="checkbox" class="hidden" name="other_meters[{{$meter->id}}]"
                                                   @if(!empty(old('other_meters.'.$meter->id))) checked @endif>
                                            <span class="checkbox-placeholder"></span>
                                            {{$meter->name}}
                                        </span>
                                    </label>

                                    <div class="meter-fields" @if(!empty(old('other_meters.'.$meter->id))) style="opacity: 1" @endif>
                                        <div class="form-wrapper">
                                            ...
                                            <div class="form-group {{$errors->has('other_meters.'.$meter->id.'.serial') ? 'has-error' : ''}}">
                                                <input type="text" class="form-control input-lg" name="other_meters[{{$meter->id}}][serial]" value="{{old('other_meters.'.$meter->id.'.serial')}}"
                                                       @if(empty(old('other_meters.'.$meter->id))) disabled @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-wrapper">
                                            ...
                                            <div class="form-group {{$errors->has('other_meters.'.$meter->id.'.value') ? 'has-error' : ''}}">
                                                <input type="text" class="form-control input-lg" name="other_meters[{{$meter->id}}][value]" value="{{old('other_meters.'.$meter->id.'.value')}}"
                                                       @if(empty(old('other_meters.'.$meter->id))) disabled @endif>
                                            </div>
                                        </div>
                                    </div>
